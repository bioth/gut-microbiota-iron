...
cd ../../../16s_data_test/uncompressed_files
...
for file in *R1.fastq; do
    ...
    py -m cutadapt -b file:../r1_primers_v2.fasta -o "../trimmed_fastq/${filename_no_ext}_trimmed.fastq" "$file" > "../trimmed_fastq/${filename}_cutadapt_log.txt"
...
for file in *R2.fastq; do
    ...
    py -m cutadapt -b file:../r2_primers_v2.fasta -o "../trimmed_fastq/${filename_no_ext}_trimmed.fastq" "$file" > "../trimmed_fastq/${filename}_cutadapt_log.txt"
