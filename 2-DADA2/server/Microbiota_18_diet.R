...
setwd("~/projects/def-santosmm/jr34106/data/Microbiota_18/trimmed_fastq/")
...
existingDirCheck("../../Microbiota_18_19_diet/dada2_filtered_and_trimmed/")
path = "../../Microbiota_18_19_diet/dada2_filtered_and_trimmed"
...
existingDirCheck("../../Microbiota_18_19_diet/r_console_output")
run <- paste0("../../Microbiota_18_19_diet/r_console_output/", run, dataset,"_narval.txt")
sink(run)

# Filter and trim
out <- filterAndTrim(r1_fastq, filtR1, r2_fastq, filtR2, truncLen=c(260,240),
...
ggsave(dpi = 300, filename = "../../Microbiota_18_19_diet/r_console_output/error_plotR1_m1.png", height = 10, width = 10)
plotErrors(errR2, nominalQ=TRUE)
ggsave(dpi = 300, filename = "../../Microbiota_18_19_diet/r_console_output/error_plotR2_m1.png", height = 10, width = 10)
...
ggsave(dpi = 300, filename = "../../Microbiota_18_19_diet/r_console_output/dada_plotR1_m1.png", height = 10, width = 10)
plotErrors(dadaR2, nominalQ=TRUE)
ggsave(dpi = 300, filename = "../../Microbiota_18_19_diet/r_console_output/dada_plotR2_m1.png", height = 10, width = 10)
...
existingDirCheck("../../Microbiota_18_19_diet/asv_table")
write.table(asv_table, sep = ";", file = "../../Microbiota_18_19_diet/asv_table/asv_table_M18.csv", col.names = TRUE)
