...
correlationMultipleGroups <- function(ps, deseq, measure = "log2fold", varToCompare, taxa = "Species", threshold = 0.05, FDR = TRUE, displayPvalue = FALSE, path, df, global = TRUE, singleVariable = FALSE, showIndivCor = FALSE, transformation = "CLR", displayOnlySig = FALSE, returnMainFig = FALSE, displaySpeciesASVNumber = TRUE, includeUnknownSpecies = FALSE, colorsHmap = c("blue","red")){
...
correlation2VarSelectASVs <- function(ps, measure = "log2fold", varToCompare, asvList, taxa = "Species", threshold = 0.05, FDR = TRUE, displayPvalue = FALSE, path, df, showIndivCor = FALSE, transformation = "rel_ab", displayOnlySig = FALSE, returnMainFig = TRUE, displaySpeciesASVNumber = TRUE, colorsHmap = c("#d1762d","#639381")){
  ...
  #Keep only ASVs of interest in counts from ps_object
  counts <- counts[rownames(counts) %in% asvList,]
