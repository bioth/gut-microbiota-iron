...
sample_names <- sub(".*\\.([0-9]+(?:_Weaning)?).*", "\\1", basename(r1_fastq))
# Remove the last character
sample_names <- substr(sample_names, 1, nchar(sample_names) - 1)

#Quality filtering of the reads
# Place filtered files in filtered/ subdirectory
phath = "../dada2_filtered_and_trimmed"ùùlmlùlllùllùùlmmpmplmlùùlmpmmlùm,nn,,nklùmùllùmllùùùùùll,nhbnhhn,hj,ùùùùùùùlùmlùmlùlùlmp.¨,
j
