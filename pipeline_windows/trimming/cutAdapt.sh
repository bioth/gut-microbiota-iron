...
cd ../../Microbiota_17/uncompressed_files
...
for file in *R1.fastq; do
    ...
    py -m cutadapt -g file:../primers/r1_primers.fasta -o "../trimmed_fastq/${filename_no_ext}_trimmed.fastq" "$file" > "../trimmed_fastq/${filename}_cutadapt_log.txt"
...
for file in *R2.fastq; do
    ...
    py -m cutadapt -g file:../primers/r2_primers.fasta -o "../trimmed_fastq/${filename_no_ext}_trimmed.fastq" "$file" > "../trimmed_fastq/${filename}_cutadapt_log.txt"
